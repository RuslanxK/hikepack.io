      ...
      <table className="w-full text-sm text-left text-gray-500 dark:text-gray-200">
        <thead className="text-xs text-gray-700 uppercase dark:text-gray-400">
          <tr>
            ...
            className="text-gray-900 dark:text-gray-200 focus:outline-none dark:bg-transparent font-medium text-sm text-center border border-gray-300 dark:border-zinc-500 cursor-pointer"
             >
           {['lb', 'kg', 'g', 'oz'].map((unit) => (
